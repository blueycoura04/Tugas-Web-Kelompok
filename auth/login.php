        ...
        <div class="col-lg-6 d-none d-lg-block">
            <div class="p-5 text-center">
                ...
                <div class="mt-5 p-4 rounded-4 shadow-sm"
                    ...
                    <i class="bi bi-bag-heart-fill" style="font-size:80px;"></i>
                    <h4 class="mt-3 fw-bold">Mochimo Store</h4>
                    <p class="mb-0">Belanja lebih cepat & mudah 🚀</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-5">
                    ...
                    <div class="text-center mt-4">
                        <p class="mb-0 text-secondary">
                            Belum punya akun? 
                            <a href="register.php" class="text-danger fw-bold text-decoration-none">
                                Daftar Sekarang
                            </a>
                        </p>
                    </div>
